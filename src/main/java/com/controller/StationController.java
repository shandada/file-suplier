...
public class StationController {
  ...
  public Object queryByContainerId(@RequestParam("containerId")@ApiParam(value = "镜像id",required = true) String containerId, @ApiParam("当前页数") @RequestParam("current")Integer current, @RequestParam("pageSize")@ApiParam("每页数据条数") Integer pageSize){
   return stationService.queryByContainerId(containerId, current, pageSize);
  }
}
