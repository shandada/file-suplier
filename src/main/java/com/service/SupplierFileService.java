...
public class SupplierFileService extends ServiceImpl<SupplierMapper, Supplier> {
    ...
    public void upload(String bucketName, String fileKey, MultipartFile file) throws IOException {
        ...
        System.out.println("files:" + files + "--------" + "桶名: " + bucketName);
        //连接CEph
//        CephClient cephClient = CephClient.getCephClient(CephPropertiesUtil.ADMIN, CephPropertiesUtil.KEY, CephPropertiesUtil.CEPH_IP);
